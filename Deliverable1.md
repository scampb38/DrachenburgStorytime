...
**Scrum Master**: Gavin Beaudry

**Git Master**: Shea Campbell

### Sprint Planning (For Sprint 1-3)
Document your Sprint Planning here. Also check the kickoff document for more details on what needs to be done. This is just the documentation. 

**Sprint Goal:** Understand the main features of Memoranda and fix obvious bugs so that the original program runs as intended and we can identify key aspects that will be changed for the new program.
...
> US2 Should be easy to implement and keep us notified if we're working on the correct build
> US22 Will help bring cohesion to the program while making it unique

**Why do you think these fit well with your Sprint goal? (details)**

> They are both obvious bugs that need to be fixed.
